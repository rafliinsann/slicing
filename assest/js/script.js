...
window.addEventListener("scroll", fadeInBox1);
window.addEventListener("scroll", fadeInBox2);
window.addEventListener("scroll", fadeInBox3);
window.addEventListener("scroll", fadeInBox4);
window.addEventListener("scroll", fadeInBox5);
window.addEventListener("scroll", fadeInBox6);
